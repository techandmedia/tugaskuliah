...
export default class FormInventory extends React.Component {
  ...
  handleCategoryChange = value => { let val = value.length - 1; this.setState({ category: value[val] }) }
  handleOsChange = value => { let val = value.length - 1; this.setState({ os: value[val] }) }
